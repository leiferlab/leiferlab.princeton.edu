	...
	<div class="container">
		<div class="row">
			...
			<div class="span4">
			  ...
			  &nbsp;
						<p>My research combines techniques from neuroscience, physics, engineering and computer science to study the dynamics of neural circuits in awake moving organisms. We are located at the inter-disciplinary <a href="http://genomics.princeton.edu">Lewis-Sigler Institute for Integrative Genomics</a>.  
					</p>
		...
		<article class="span4 project">
			...
			<div class="thumbnail equalizeHeight">
				...
				<div class="project-description">
					...
					<i class="icon-link"></i>
					<!-- name -->
					<b class="project-name"> Leifer</b> joins  <a href="https://www.simonsfoundation.org/life-sciences/simons-collaboration-on-the-global-brain-2/whole-brain-calcium-imaging-in-freely-behaving-nematodes/" target="_blank">Simons Foundation Collaboration on the Global Brain</a> project.
				</div>
				<!-- ribbon -->
