...
?>
	...
	<section id="team-members">
		...
		<article class="member">
			...
			<h4 class="member-position">Principal Investigator</h4>
			<p class="member-contact">
				...
				<i class="icon-twitter"></i> <a href="https://twitter.com/AndrewLeifer">Twitter</a> &nbsp; <i class="icon-github"></i> <a href="https://github.com/aleifer/">GitHub</a> &nbsp; <i class="icon-google"></i> <a href="http://scholar.google.com/citations?user=b0DQef8AAAAJ">Google Scholar</a> &nbsp; <i class="icon-globe"></i> <a href="http://www.andrewleifer.com">Personal Homepage</a> &nbsp; <i class="icon-asterisk"> <a href="http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=18826+Leifer">Asteroid</a> &nbsp; <i class="icon-file"></i> <a href="">CV</a>
			</p>
			<p class="member-bio">
